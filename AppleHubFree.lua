--[[
!! WARNING !!
Script Được Open Source, Nếu Bạn Muốn Skid Thì Hãy Skid, Những Nhớ Nghi Nguồn Giúp Tôi, Xin Cảm Ơn!!
Nếu Bạn Muốn Ủng Hộ Tôi, Hãy Donate: 
MBBANK: 9999180129009
Momo: 0865590307
TSR: minhtientiny@gmail.com
Ctk: Nguyen Minh Nhat
Xin Cảm Ơn!!

Script Open Source, If You Want To Skid Then Skid, If You Remember The Source Help Me, Thank You!!
Сценарий с открытым исходным кодом. Если вы хотите занести, то занесите, пожалуйста, запомните источник, чтобы помочь мне, спасибо!
]]
...
if support[exploit()]  then
    print("đúng exploit r chạy thôi uwu") 
]]
...
elseif game.PlaceId == 7449423635 then
    ...
    game:GetService("Players").LocalPlayer:Kick("Do Not Support, Only Blox Fruit.")
end
...
function Update:Window(text,logo,keybind)
    ...
    Ping.Text = "Notification On Administrator: ".. _G.ThongBao
...
spawn(function()
    ...
    spawn(function()
        pcall(function()
            game:GetService("RunService").Stepped:Connect(function()
                if _G.AutoAdvanceDungeon or _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.AutoFarmChest or _G.AutoFactory or _G.AutoFarmBossHallow or _G.AutoFarmSwanGlasses or _G.AutoLongSword or _G.AutoBlackSpikeycoat or _G.AutoElectricClaw or _G.AutoFarmGunMastery or _G.AutoHolyTorch or _G.AutoLawRaid or _G.AutoFarmBoss or _G.AutoTwinHooks or _G.AutoOpenSwanDoor or _G.AutoDragon_Trident or _G.AutoSaber or _G.NOCLIP or _G.AutoFarmFruitMastery or _G.AutoFarmGunMastery or _G.TeleportIsland or _G.Auto_EvoRace or _G.AutoFarmAllMsBypassType or _G.AutoObservationv2 or _G.AutoMusketeerHat or _G.AutoEctoplasm or _G.AutoRengoku or _G.Auto_Rainbow_Haki or _G.AutoObservation or _G.AutoDarkDagger or _G.Safe_Mode or _G.MasteryFruit or _G.AutoBudySword or _G.AutoOderSword or _G.AutoBounty or _G.AutoAllBoss or _G.Auto_Bounty or _G.AutoSharkman or _G.Auto_Mastery_Fruit or _G.Auto_Mastery_Gun or _G.Auto_Dungeon or _G.Auto_Cavender or _G.Auto_Pole or _G.Auto_Kill_Ply or _G.Auto_Factory or _G.AutoSecondSea or _G.TeleportPly or _G.AutoBartilo or _G.Auto_DarkBoss or _G.GrabChest or _G.AutoFarmBounty or _G.Holy_Torch or _G.AutoFarm or _G.Clip or _G.AutoElitehunter or _G.AutoThirdSea or _G.Auto_Bone or _G.Autoheart or _G.Autodoughking or _G.AutoFarmMaterial or _G.AutoNevaSoulGuitar or _G.Auto_Dragon_Trident or _G.Autotushita or _G.Autowaden or _G.Autogay or _G.Autopole or _G.Autosaw or _G.AutoObservationHakiV2 or _G.AutoFarmNearest or _G.AutoCarvender or _G.AutoTwinHook or AutoMobAura or _G.Tweenfruit or _G.TeleportNPC or _G.AutoKai or _G.Leather or _G.Auto_Wing or _G.Umm or _G.SimpRose or Radioactive or Fish or Gunpowder or Dragon_Scale or Cocoafarm or Scrap or MiniHee or _G.AutoFarmSeabaest or Auto_Cursed_Dual_Katana or _G.AutoFarmMob or _G.AutoMysticIsland or _G.AutoFarmDungeon or _G.AutoRaidPirate or _G.AutoQuestRace or _G.TweenMGear or getgenv().AutoFarm or _G.AutoPlayerHunter or _G.AutoFactory or _G.Namfon or _G.AutoSwordMastery or _G.Auto_Seabest or _G.AutoSeaBest or _G.AutoKillTial or _G.Auto_Saber or _G.Position_Spawn or _G.TPB or _G.Farmfast or _G.AutoRace or _G.RaidPirate or Open_Color_Haki or _G.AutoTerrorshark or FarmShark or _G.farmpiranya or _G.Fish_Crew_Member or _G.DomadicAutoDriveBoat or _G.AutoFrozenDimension or _G.AutoFKitsune == true then
...
local Main = Library:AddTab("Farming","13075651575")
local M = Library:AddTab("Item/Quest","13075622619")
local RaceV4 = Library:AddTab("Race V4/Event","11162889532")
local P = Library:AddTab("Player/Teleport","7251993295")
local Visual = Library:AddTab("Visual","16073262498")
local R = Library:AddTab("Dungeon","11155986081")
local S = Library:AddTab("Shop/Stats","6031265976")
local D = Library:AddTab("Devil Fruit","7044233235")
local Misc = Library:AddTab("Misc","11156061121")

H:AddSeperator("Information")
H:AddLabel("Owners: Nguyen Minh Tien")
H:AddSeperator("Social Network")

H:AddButton("Discord Official", function()
setclipboard(_G.Discord)
end)
H:AddButton("YouTube Official", function()
setclipboard(_G.YouTube)
end)
H:AddButton("Tik Tok Official", function()
setclipboard(_G.TikTok)
end)
H:AddSeperator("Donate Me Please! [Click Button To Copy]")
H:AddButton("MB Bank [9999180129009]", function()
setclipboard("9999180129009")
end)
H:AddButton("Momo [0865590307]", function()
setclipboard("0865590307")
end)
H:AddButton("The Sieu Re [minhtientiny@gmail.com]", function()
setclipboard("minhtientiny@gmail.com")
end)
H:AddButton("Chu Tai Khoan: Nguyen Minh Nhat", function()
setclipboard("Nguyen Minh Nhat")
end)

Main:AddSeperator("Farming")

Main:AddToggle("Bypass Anti-Cheat: Anti Flag",true,function(value)
                            ...
                            if v.Name == "Factory Staff" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        v.Humanoid.WalkSpeed = 0
                                        v.Head.CanCollide = false 
                                        NguyenTienSimpRose = true
                                        NguyenTienSimpRoseee = v.HumanoidRootPart.CFrame
                                        topos(v.HumanoidRootPart.CFrame * Pos)
                                        game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                    until not Radioactive or not v.Parent or v.Humanoid.Health <= 0
                                    NguyenTienSimpRose = false
                                end
                            end
                        end
                    else
                            ...
                            if v.Name == "Water Fighter" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        game:GetService("VirtualUser"):CaptureController()
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                    until not _G.SimpRose or not v.Parent or v.Humanoid.Health <= 0
                                    NguyenTienSimpRose = false
                                end
                            end
                        end
...
M:AddToggle("Auto Farm Magma Ore",_G.SimpRose,function(value)
_G.Umm = value
StopTween(_G.Umm)
end)
...
if World1 then  
M:AddToggle("Auto Farm Angel Wings",_G.SimpRose,function(value)
_G.Auto_Wing = value
...
if World1 or World2 or World3 then   
M:AddToggle("Auto Farm Leather",_G.SimpRose,function(value)
_G.Leather = value
...
spawn(function()
    ...
    M:AddToggle("Hop Farm",_G.SimpRose,function(value)
    _G.StardHop = value
    end)
...
task.spawn(function()
	while task.wait() do
		pcall(function()
			if NguyenTienSimpRose and _G.BringMonster then
				for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
					if not string.find(v.Name,"Boss") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
						if InMyNetWork(v.HumanoidRootPart) then
							v.HumanoidRootPart.CFrame = NguyenTienSimpRoseee
							v.Humanoid.JumpPower = 0
							v.Humanoid.WalkSpeed = 0
							v.HumanoidRootPart.Size = Vector3.new(60,60,60)
							v.HumanoidRootPart.Transparency = 1
...
task.spawn(function()
	while task.wait() do
		pcall(function()
			if MinhTienXP and _G.BringMonster then
				for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
					if not string.find(v.Name,"Boss") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
						if InMyNetWork(v.HumanoidRootPart) then
...
S:AddToggle("Auto Stats Kaitun",_G.Auto_Stats_Kaitun,function(value)
_G.Auto_Stats_Kaitun = value
end)
...
S:AddToggle("Melee",false,function(Value)
melee = Value    
end)
S:AddToggle("Defense",false,function(value)
defense = value
end)
S:AddToggle("Sword",false,function(value)
sword = value
end)
S:AddToggle("Gun",false,function(value)
gun = value
end)
S:AddToggle("Devil Fruit",false,function(value)
demonfruit = value
end)

PointStats = 1
S:AddSlider("Point",1,100,PointStats,nil,function(value)
PointStats = value
end)
...
Visual:AddToggle("Esp Gear [Beta]", false, function(value)
    GearESP = value
...
spawn(function()
 ...
 RaceV4:AddButton("Auto Complete Angel Trial",function(t)
    ...
    RaceV4:AddSeperator("Rough Sea")
    
    RaceV4:AddToggle("Auto Drive Boat", _G.DomadicAutoDriveBoat,function(value)
    ...
    RaceV4:AddToggle("Auto Farm Terrorshark", _G.AutoTerrorshark,function(value)
         _G.AutoTerrorshark = value
        StopTween( _G.AutoTerrorshark)
    end)
    
    RaceV4:AddToggle("Auto Farm Shark",FarmTFully,function(value)
    FarmShark = value
    StopTween(FarmShark)
    end)
    ...
    RaceV4:AddToggle("Auto Farm Piranha",_G.farmpiranya,function(value)
    _G.farmpiranya = value
    StopTween(_G.farmpiranya)
    end)
    
    RaceV4:AddToggle("Auto Fish Crew Member",_G.Fish_Crew_Member,function(value)
    _G.Fish_Crew_Member = value
    StopTween(_G.Fish_Crew_Member)
    end)
    
    RaceV4:AddToggle("Auto Terrorshark Hop", _G.AutoTerrorsharkhop,function(value)
    ...
    RaceV4:AddToggle("Auto Raid Ship",_G.KillGhostShip,function(value)
    ...
    RaceV4:AddToggle("Auto Ghost Ship",_G.bjirFishBoat,function(value)
...
FrozenIsland = RaceV4:AddLabel("")
     
    RaceV4:AddToggle("Auto Frozen Dimension",_G.AutoFrozenDimension,function(value)
    _G.AutoFrozenDimension = value
    StopTween(_G.AutoFrozenDimension)
    end)
    
    RaceV4:AddToggle("Auto Kitsune Island",_G.AutoFKitsune,function(value)
    ...
    StopTween(_G.AutoFKitsune)
        ...
        local StatusKitsune = RaceV4:AddLabel("")

function UpdateKitsune()
    if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
        StatusKitsune:Set("Kitsune Island: Found")
    else
        StatusKitsune:Set("Kitsune Island: Not Found")
     end
end
...
RaceV4:AddToggle("Auto Teleports To Kitsune Island",_G.TptoKisuneIsland,function(value)
    _G.TptoKisuneIsland = value
    StopTween(_G.TptoKisuneIsland)
    end)
    
RaceV4:AddToggle("Auto Teleports To Kitsune Shrine",_G.TptoKisuneshrine,function(value)
    _G.TptoKisuneshrine = value
    StopTween(_G.TptoKisuneshrine)
    end)
...
RaceV4:AddToggle("Auto Collect Azure Ember",_G.GetAzureEmber,function(value)
...
spawn(function()
 ...
 R:AddToggle("Auto Law Sword (New !)", _G.AutoOderSword,function(value)
    ...
    P:AddSeperator("World")
    
    P:AddButton("Teleport To Old World",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    P:AddButton("Teleport To Second Sea",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    P:AddButton("Teleport To Third Sea",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    
    P:AddButton("Teleport to Seabeast",function()
        for i,v in pairs(game:GetService("Workspace").SeaBeasts:GetChildren()) do
            if v:FindFirstChild("HumanoidRootPart") then
    ...
    P:AddSeperator("Island")
    
    if World1 then
        P:AddDropdown("Select Island",{
            "WindMill",
            "Marine",
            "Middle Town",
            "Jungle",
    ...
    P:AddToggle("Teleport",_G.TeleportNPC,function(value)
...
if World1 then
	P:AddDropdown("Select Island Bypass Tp",{
		"WindMill",
		"Marine",
		"Middle Town",
		"Jungle",
...
P:AddButton("Bypass Tp",function(value)
...
Visual:AddToggle("Remove Fog",RemoveFog,function(value)
    ...
    Visual:AddButton("Remove Lave",function()
		for i,v in pairs(game.Workspace:GetDescendants()) do
			if v.Name == "Lava" then   
				v:Destroy()
			end
...
UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 0, 0)), ColorSequenceKeypoint.new(0.49, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 0, 0))}
...
TextLabel.Text = "Welcome To Apple Hub"
...
Toggle.Position = UDim2.new(0, 40, 0.454706937, 0)
Toggle.Size = UDim2.new(0, 50, 0.0888099447, 0)
Toggle.Font = Enum.Font.SourceSans
Toggle.Text = "Stop Tween"
...
--[[else
    game:GetService("Players").LocalPlayer:Kick("[Apple Hub] How To Changes Exploit (Only Fluxus)")
end]]