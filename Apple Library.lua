...
--[[	local NewDropShadow = Instance.new("ImageLabel")
	...
	function hoho_wind:AddTab(tab_name)
		...
		function hoho_tab:AddButton(text, func)
		...
		function hoho_tab:AddLabel(label_text, properties)
		...
		function hoho_tab:AddToggle(toggle_text, state, func)
		...
		function hoho_tab:AddSlider(txt, min, max, mid, func)
		...
		function hoho_tab:AddDropdown(txt,list,func)
		...
		function hoho_tab:AddTextbox(txt,txt_hold,func)
